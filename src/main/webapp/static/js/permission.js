...
function findById(id) {
    var obj = {};
    $.ajax({
        url: getRootPath()+'/permissions/findById.do?id=' + id,
        type: 'get',
        async: false,
        success: (data) => {
            obj = data;
...
function findPermissionByRoleId(id) {
    var obj = {};
    $.ajax({
        url: getRootPath()+'/permissions/findRoleByPermissionId.do?id=' + id,
        type: 'get',
        async: false,
        success: (data) => {
            obj = data;
...
function permissionBtn(id) {
    ...
    $(function () {
        ...
        $.ajax({
            url: getRootPath()+'/permissions/getRolesZTree.do',
            type: 'get',
            dataType: "json",
            success: (data) => {
                console.log(data);
...
function surePermission() {
    ...
    //提交
    $.ajax({
        url: getRootPath()+'/permissions/updateRolesPermissions.do',
        type: 'post',
        dataType: 'json',
...
$(".status-sure").click(function () {
    ...
    $.ajax({
        url: getRootPath()+'/permissions/update.do',
        type: 'post',
        dataType: 'json',
        contentType: 'application/json;charset=UTF-8',
        data: JSON.stringify({
...
function deleteRole(id) {
    if (id != null && id != "") {
        $.ajax({
            url: getRootPath()+'/permissions/delete.do?id=' + id,
            type: 'get',
            success: (data) => {
                if (data.success) {
                    window.location.reload();
...
$(".create-sure").click(function () {
    ...
    //创建用户
    $.ajax({
        url: getRootPath()+'/permissions/create.do',
        type: 'post',
        dataType: 'json',
        contentType: 'application/json;charset=UTF-8',
        data: JSON.stringify({
